...
public class DisplayUserImageActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        DatabaseReference mUserDatabase = FirebaseDatabase.getInstance("https://chatting-a6254-default-rtdb.firebaseio.com/").getReference().child("users").child(CurrentUserId);
