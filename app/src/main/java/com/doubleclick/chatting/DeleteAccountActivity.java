...
public class DeleteAccountActivity extends AppCompatActivity {
    ...
    private void DeleteUserAccountFromDatabase(){
        ...
        FirebaseDatabase.getInstance("https://chatting-a6254-default-rtdb.firebaseio.com/").getReference().child("users").child(CurrentUserId).removeValue();
        FirebaseDatabase.getInstance("https://chatting-a6254-default-rtdb.firebaseio.com/").getReference().child("requests").child(CurrentUserId).removeValue();
        FirebaseDatabase.getInstance("https://chatting-a6254-default-rtdb.firebaseio.com/").getReference().child("friends").child(CurrentUserId).removeValue();
        FirebaseDatabase.getInstance("https://chatting-a6254-default-rtdb.firebaseio.com/").getReference().child("chats").child(CurrentUserId).removeValue();
