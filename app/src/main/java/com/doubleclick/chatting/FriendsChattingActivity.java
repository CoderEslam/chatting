...
public class FriendsChattingActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        FirebaseDatabase.getInstance("https://chatting-a6254-default-rtdb.firebaseio.com/").getReference().child("users").child(CurrentUID).child("Online").setValue("true");
        FirebaseDatabase.getInstance("https://chatting-a6254-default-rtdb.firebaseio.com/").getReference().child("users").child(CurrentUID).child("Seen").setValue("seen");
        ...
        SendMessageBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (message_value.isEmpty())
                    Toast.makeText(FriendsChattingActivity.this, "The message is empty", Toast.LENGTH_SHORT).show();
                else {
                ...
                PlayOrPauseRecordBtn.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View view) {
                        ...
                        try {
                            ...
                            if (isRecordSending)
                                mediaPlayer.setDataSource(message.getSenderMessage());
...
//**********************************************************************************************
                ...
                if (dataSnapshot.exists()) {
                    for (DataSnapshot Snapshot : dataSnapshot.getChildren()) {
                        if (Snapshot.child("Message").getValue().toString().substring(0, 1).equals("S")) {
                            FirebaseDatabase.getInstance("https://chatting-a6254-default-rtdb.firebaseio.com/").getReference().child("chats").child(UserId).child(CurrentUID).child(Snapshot.getKey().toString()).child("Message State").setValue("3");
                        }
                    }
                }
            }
        ...
        ValueEventListener eventListener = new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                if (dataSnapshot.exists()) {
                    ...
                    FirebaseDatabase.getInstance("https://chatting-a6254-default-rtdb.firebaseio.com/").getReference().child("chats").child(CurrentUID).child(UserId).push().setValue(SendHashMap);
                    FirebaseDatabase.getInstance("https://chatting-a6254-default-rtdb.firebaseio.com/").getReference().child("chats").child(UserId).child(CurrentUID).push().setValue(ReceiveHashMap);
    ...
    private void ChangeInChatting() {
        ...
        DatabaseReference mFirebase = FirebaseDatabase.getInstance("https://chatting-a6254-default-rtdb.firebaseio.com/").getReference().child("chats").child(CurrentUID).child(UserId);
                        ...
                        ValueEventListener eventListener = new ValueEventListener() {
                            ...
                            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                                if (dataSnapshot.exists()) {
                                    for (DataSnapshot Snapshot : dataSnapshot.getChildren()) {
                                        if (Snapshot.child("Message").getValue().toString().substring(0, 1).equals("S")) {
                                            FirebaseDatabase.getInstance("https://chatting-a6254-default-rtdb.firebaseio.com/").getReference().child("chats").child(CurrentUID).child(UserId).child(Snapshot.getKey().toString()).child("Message State").setValue("3");
                                        }
                                    }
                                }
                            }
                                ...
                                if (dataSnapshot.exists()) {
                                    for (DataSnapshot Snapshot : dataSnapshot.getChildren()) {
                                        if (Snapshot.child("Message").getValue().toString().substring(0, 1).equals("S") && !Snapshot.child("Message State").getValue().toString().equals("3")) {
                                            FirebaseDatabase.getInstance("https://chatting-a6254-default-rtdb.firebaseio.com/").getReference().child("chats").child(CurrentUID).child(UserId).child(Snapshot.getKey().toString()).child("Message State").setValue("2");
                                        }
                                    }
                                }
                            }
                ...
                if (dataSnapshot.exists()) {
                    for (DataSnapshot Snapshot : dataSnapshot.getChildren()) {
                        if (Snapshot.child("Message").getValue().equals("R" + message.getReceiverMessage()) || Snapshot.child("Message").getValue().equals("S" + message.getSenderMessage())) {
                            //delete message
                            FirebaseDatabase.getInstance("https://chatting-a6254-default-rtdb.firebaseio.com/").getReference().child("chats").child(CurrentUID).child(UserId).child(Snapshot.getKey()).removeValue();
                ...
                if (dataSnapshot.exists()) {
                    for (DataSnapshot Snapshot : dataSnapshot.getChildren()) {
                        if (Snapshot.child("Message").getValue().equals("R" + message.getReceiverMessage()) ||
                            ...
                            //delete message
                            FirebaseDatabase.getInstance("https://chatting-a6254-default-rtdb.firebaseio.com/").getReference().child("chats").child(UserId).child(CurrentUID).child(Snapshot.getKey()).removeValue();
        ...
        ValueEventListener eventListener = new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                if (dataSnapshot.exists()) {
                    ...
                    FirebaseDatabase.getInstance("https://chatting-a6254-default-rtdb.firebaseio.com/").getReference().child("chats").child(CurrentUID).child(UserId).push().setValue(SendImageHashMap);
                    FirebaseDatabase.getInstance("https://chatting-a6254-default-rtdb.firebaseio.com/").getReference().child("chats").child(UserId).child(CurrentUID).push().setValue(ReceiveImageHashMap);
